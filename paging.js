...
(function($) {
    ...
    $.fn.JPaging = function(param) {
      var params = $.extend({ pageSize: 2, visiblePageSize: 1 }, param);
      ...
      if ($pageCount >= 1 && $visiblePageSize >= 1) {
        $("#paging").append(
          "<a href='javascript:void(0)' style='font-weight:bolder; font-size:1.5em;'>" + "<i class='fa fa-arrow-left' aria-hidden='true'></i>"
        );
        if ($pageCount > $visiblePageSize) {
          $("#paging").append(
            "<a href='javascript:void(0)' id='pre_point' class='hidden'>" + "1"
          );
        }
        ...
        if ($pageCount > $visiblePageSize) {
          $("#paging").append(
            "<a href='javascript:void(0)' id='next_point'>" + "2"
          );
        }
        $("#paging").append(
          "<a href='javascript:void(0)' style='font-weight:700; font-size:1.5em;'>" +"<i class='fa fa-arrow-right' aria-hidden='true'></i>"
        );
